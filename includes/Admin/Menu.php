...
class Menu{
    ...
    public function admin_menu() {
        ...
        add_menu_page( __( 'Asteria Academy', 'asteria-academy' ), __( 'Asteria Ac','asteria-academy' ), $capability , $parent_slug ,[ $this, 'asteria_menu_page' ] ,'dashicons-welcome-learn-more', 30 );

        add_submenu_page($parent_slug, __( 'Address Book', 'asteria-academy' ), __( 'Address Book', 'asteria-academy' ) , $capability , $parent_slug, [ $this, 'asteria_menu_page' ] );
